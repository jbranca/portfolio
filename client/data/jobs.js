module.exports = [
  ...
  },
  {
    ...
    description: [
      ...
      `Architected standards across Sporting News and NBA using Webpack, Babel JS, ESLint and Sass.`,
      `Added support for Shorthand, including adding tracking by processing files through Amazon S3 and Lambda`
    ]
  },
  {
    ...
    description: [
      ...
      `Added Windows Phone and Windows 8 alert notifications, including game alerts.`,
    ]
  },
  {
    ...
    description: [
      ...
      `Contributed to the design and development of web applications for various advertising campaigns that utilized a LAMP stack.`,
      `Converted statistics XML parsers to use MySQL instead of Oracle.`,
      `Converted database table objects to use Doctrine ORM, an object relational mapper.`
    ]
  },
  {
    title: 'Web Developer',
